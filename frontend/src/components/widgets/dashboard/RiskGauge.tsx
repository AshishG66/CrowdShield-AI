  ...
  return (
    <Card className={cn("overflow-hidden border hover:shadow-md transition-all duration-200 border-muted-foreground/10", className)}>
      ...
      <CardContent className="p-5 flex flex-col items-center justify-center space-y-4">
        ...
        <div className="w-full mt-2 pt-2 border-t border-muted-foreground/10 flex items-center justify-between text-[9px] font-mono text-muted-foreground/60">
          <span className="truncate pr-1">API: GET /api/dashboard/risk</span>
          <span className="shrink-0 bg-muted px-1.5 py-0.5 rounded text-[8px] font-semibold text-primary">CrowdReading, Prediction</span>
        </div>
      </CardContent>
    </Card>
  );
